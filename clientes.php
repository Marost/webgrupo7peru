      ...
      <div id="contenido">
          ...
          <h1 class="texto24-plomo">
            <object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="740" height="100">
              <param name="movie" value="flash/titulo_clientes.swf" />
              <param name="quality" value="high" />
              ...
              <!-- La siguiente etiqueta object es para navegadores distintos de IE. Ocúltela a IE mediante IECC. -->
              <!--[if !IE]>-->
              <object type="application/x-shockwave-flash" data="flash/titulo_clientes.swf" width="740" height="100">
                <!--<![endif]-->
                <param name="quality" value="high" />
                <param name="wmode" value="opaque" />
                <param name="swfversion" value="6.0.65.0" />
        ...
        <table width="740" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="47%" height="158%" align="left" valign="middle"><ul>
              <li>Abaco </li>
              <li> Asociación de Tenistas Profesionales (ATP) </li>
              <li> Asociación de Instituciones de Microfinanzas del Perú (ASOMIF)</li>
              <li> Caja Metropolitana de Lima </li>
              <li> Caja Municipal de Arequipa </li>
              <li> Caja Municipal de Huancayo </li>
              <li> Caja Municipal de Ica </li>
              <li> Caja Municipal de Maynas </li>
              <li> Caja Municipal de Piura </li>
              <li> Caja Municipal del Santa </li>
              <li> Caja Municipal de Trujillo </li>
              <li> Cámara de Comercio de Lima </li>
              <li> Credinka </li>
              <li> Cerveza Cusqueña </li>
              <li> Edpyme Confianza</li>
              <li> Federación de Cajas Municipales del Perú</li>
              <li>                Federación Internacional de Tenis (ITF)</li>
              <li> Fogapi</li>
              <li> FONAFE </li>
              <li> G. W. Yichang &amp; Cía S.A.</li>
              <li> Instituto ARIE</li>
              <li> Ministerio de la Mujer y Desarrollo Social</li>
              <li> Osinfor</li>
              <li> Pardo’s Chicken</li>
              <li> Promperú</li>
              <li> Protransporte</li>
              <li> Telefónica del Perú </li>
              <li> Universidad Católica del Perú</li>
